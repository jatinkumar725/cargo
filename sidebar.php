      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            <a href="./" class="nav-link nav-home">
              <img src="./assets/uploads/Dashboard.png" alt="">
              <p>
                Dashboard
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_branch">
              <img src="./assets/uploads/Branch.png" alt="">
              <p>
                Branch
          ...
          <li class="nav-item">
            ...
            <img src="./assets/uploads/Branch-Staff.png" alt="">
              <p>
                Branch Staff
                <i class="bi bi-caret-right-fill right"></i>
              </p>
        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <img src="./assets/uploads/Parcel.png" alt="">
              <p>
                Parcels
                <i class="bi bi-caret-right-fill right"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              ...
              ?>
              <li class="nav-item">
                <a href="./index.php?page=parcel_list&s=<?php echo $v ?>" class="nav-link nav-parcel_list_<?php echo str_replace(' ', '_', $v); ?> tree-item">
                  <img src="./assets/uploads/<?php echo str_replace(' ', '-', $v); ?>-side.png" alt="">
                  <p>
                    <?php
           ...
           <li class="nav-item dropdown">
            ...
            <img src="./assets/uploads/Track-Parcel.png" alt="">
              <p>
                Track Parcel
              </p>
            </a>
           ...
           <li class="nav-item dropdown">
            ...
            <img src="./assets/uploads/report.png" alt="">
              <p>
                Reports
              </p>
            </a>
